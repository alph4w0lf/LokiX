      ...
      >
        <md-card>
          <md-card-header data-background-color="green">
            ...
            <p class="category">List of all endpoints that completed loki scans</p>
          </md-card-header>
          <md-card-content>
            <results-table table-header-color="green" :results="completed_list"></results-table>
...
export default {
  ...
  methods: {
    displayPage(PageNum) {
      ...
      this.axios.get(this.PLATFORM_URL+'/api/completed/scans?page='+PageNum)
      .then(response => {
        ...
        this.completed_list = response.data.data;
      })
      .catch(e => {
        this.checkAuth();
      });
    ...
    searchPage(PageNum){
      ...
      this.axios.post(this.PLATFORM_URL+'/api/search/completed/scans?page='+PageNum, 
        {

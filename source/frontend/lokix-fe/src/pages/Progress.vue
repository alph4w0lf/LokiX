      ...
      >
        <md-card>
          <md-card-header data-background-color="green">
            ...
            <p class="category">List of all endpoints with scans in progress</p>
          </md-card-header>
          <md-card-content>
            <progress-table table-header-color="green" :results="progress_list"></progress-table>
...
export default {
  ...
  methods: {
    displayPage(PageNum) {
      ...
      this.axios.get(this.PLATFORM_URL+'/api/progress/scans?page='+PageNum)
      .then(response => {
        ...
        this.progress_list = response.data.data;
      })
      .catch(e => {
        this.checkAuth();
      });
    ...
    searchPage(PageNum){
      ...
      this.axios.post(this.PLATFORM_URL+'/api/search/progress/scans?page='+PageNum, 
        {
